...
KNOWN_AS_MIDDLE_PART_TEXT = ' the '
ENEMY_REPR_FIRST_PART = 'Enemy: '
ENEMY_REPR_HEALTH = 'health='
ENEMY_REPR_MANA = ' mana='
ENEMY_REPR_DAMAGE = ' damage='

HERO_INFORMATION_NAME_FIELD_TEXT = 'Name: '
HERO_INFORMATION_TITLE_FIELD_TEXT = 'Title: '
HERO_INFORMATION_KNOWN_AS_FIELD_TEXT = 'Known as: '
HERO_INFORMATION_HEALTH_FIELD_TEXT = 'Health: '
HERO_INFORMATION_MANA_FIELD_TEXT = 'Mana: '
HERO_INFORMATION_MANA_REGENERATION_RATE_FIELD_TEXT = 'Mana regeneration rate: '
HERO_INFORMATION_WEAPON_FIELD_TEXT = 'Weapon: '
HERO_INFORMATION_SPELL_FIELD_TEXT = 'Spell: '

WEAPON_STR_REPRESENTATION_CLASS_NAME = 'Weapon: '
WEAPON_STR_REPRESENTATION_DAMAGE_FIELD = ': damage: '

SPELL_STR_REPRESENTATION_CLASS_NAME = 'Spell: '
SPELL_STR_REPRESENTATION_DAMAGE_FIELD = ': damage: '
SPELL_STR_REPRESENTATION_COST_FIELD = ', cost: '
SPELL_STR_REPRESENTATION_RANGE_FIELD = ', range: '

HEALTH_POTION_STR_REPRESENTATION_CLASS_NAME = 'HealthPotion: '
HEALTH_POTION_STR_REPRESENTATION_HEALING_FIELD = ': healing: '

MANA_POTION_STR_REPRESENTATION_CLASS_NAME = 'ManahPotion: '
MANA_POTION_STR_REPRESENTATION_MANA_FIELD = ': mana: '
...
DUNGEON_GATES_NUMBER = 1
DUNGEON_MAP_FIRST_ROW_AND_COLUMN_NUMBER = 0
DUNGEON_INITIAL_CHECKPOINTS_COUNT = 0

FILE_OPEN_IN_READING_MODE = 'r'

VALIDATE_DUNGEON_NO_STARTING_POSITION_ERROR_TEXT = 'No starting point'
VALIDATE_DUNGEON_NUMBER_OF_GATES_NOT_ONE_ERROR_TEXT = "Number of gates != 1"
